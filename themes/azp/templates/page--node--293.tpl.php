          ...
          <section id="azpLocation">
            ...
            <div class="azp-location">
              <div class="azp-location-wrap">
                ...
                <div class="links">
                  <a href="#mapImage" class="azp-button">Детальніше</a>
                  <a href="/sites/default/files/Loft_presentation_mini.pdf" target="_blank">Завантажити PDF</a>
                </div>
              </div>
            </div>
            ...
            <div id="mapImage">
              <div class="imgContainer">
                ...
                <map name="Map" id="Map">
                  ...
                  <?php $node_4 = node_load(1266); ?> <!-- 1085 -->
                  ...
                  <?php $node_13 = node_load(1267); ?> <!-- 1080 -->
...
<div id="mapLegend">
    <div class="myModal normal modal fade" id="modalPlace-1" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-1">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-1"><?php print $node_1->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-1">
                        <h3><?php print $node_1->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_1, 'teaser');
    ...
    <div class="myModal normal modal fade" id="modalPlace-2" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-2">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-2"><?php print $node_2->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-2">
                        <h3><?php print $node_2->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_2, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-31" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-31">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-31"><?php print $node_31->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-31">
                        <h3><?php print $node_31->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_31, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-32" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-32">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-32"><?php print $node_32->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-32">
                        <h3><?php print $node_32->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_32, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-33" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-33">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-33"><?php print $node_33->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-33">
                        <h3><?php print $node_33->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_33, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-4" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-4">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-4"><?php print $node_4->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-4">
                        <h3><?php print $node_4->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_4, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-5" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-5">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-5"><?php print $node_5->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-5">
                        <h3><?php print $node_5->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_5, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-6" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-6">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-6"><?php print $node_6->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-6">
                        <h3><?php print $node_6->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_6, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-7" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-7">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-7"><?php print $node_7->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-7">
                        <h3><?php print $node_7->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_7, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-8" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-8">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-8"><?php print $node_8->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-8">
                        <h3><?php print $node_8->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_8, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-9" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-9">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-9"><?php print $node_9->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-9">
                        <h3><?php print $node_9->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_9, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-10" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-10">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-10"><?php print $node_10->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-10">
                        <h3><?php print $node_10->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_10, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-11" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-11">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-11"><?php print $node_11->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-11">
                        <h3><?php print $node_11->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_11, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-12" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-12">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-12"><?php print $node_12->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-12">
                        <h3><?php print $node_12->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_12, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
    ...
    <div class="myModal normal modal fade" id="modalPlace-13" tabindex="-1" role="dialog" aria-labelledby="modalPlacel-13">
        <div class="modal-dialog container" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="modalPlace-13"><?php print $node_13->title; ?></h4>
                </div>
                <div class="modal-body">
                    <div class="place place-13">
                        <h3><?php print $node_13->title; ?></h3>
                        <?php
                        $prepared_node = node_view($node_13, 'teaser');
                        $rendered_teaser = render($prepared_node);
                        print $rendered_teaser;
                        ?>
                    </div>
