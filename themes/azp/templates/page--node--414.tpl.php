                    ...
                    <section id="azpLocation">
                        ...
                        <div class="azp-location">
                            <div class="azp-location-wrap">
                                ...
                                <div class="links">
                                    <a class="azp-button" href="#mapImage">Детальнее</a>
                        ...
                        <div id="mapImage">
                            <div class="imgContainer">
                                ...
                                <map name="Map" id="Map">
                                    ...
                                    <area class="mapify-hover" data-toggle="modal" data-target="#modalPlace-1" alt="<?php print $node_1->title; ?>" title="<?php print $node_1->title; ?>" href="#mapImage" shape="poly" coords="902,858,902,801,546,593,487,620,487,671,834,887,834,869,842,862,870,878" />
